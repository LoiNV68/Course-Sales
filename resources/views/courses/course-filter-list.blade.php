...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/course-filter-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Jun 2024 14:58:39 GMT -->
<head>
        <!-- Required meta tags -->
<meta charset="utf-8" />
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-4">
                            <div class="row d-md-flex justify-content-between align-items-center">
                                <div class="col-md-6 col-lg-8 col-xl-9">
                                    <h4 class="mb-3 mb-md-0">Displaying 9 out of 68 courses</h4>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body border-top">
                                    ...
                                    <div class="custom-control custom-radio mb-1">
                                        ...
                                        <label class="form-check-label" for="starRadio4">
                                            <span class="fs-6 align-top me-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-star-fill text-warning" viewBox="0 0 16 16">
                                                    <path
                                                        d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-8 col-12">
                            <div class="tab-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            ...
                                            <div class="card mb-4 card-hover">
                                                ...
                                                <!-- Card body -->
                                                <div class="card-body">
                                                    <h4 class="mb-2 text-truncate-line-2"><a href="course-single.html" class="text-inherit">Gatsby JS: build blog with GraphQL and React</a></h4>
                                                    <!-- List inline -->
                                                    <ul class="mb-3 list-inline">
                                                        <li class="list-inline-item">
                                                            <span>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            ...
                                            <div class="card mb-4 card-hover">
                                                ...
                                                <!-- Card body -->
                                                <div class="card-body">
                                                    <h4 class="mb-2 text-truncate-line-2"><a href="course-single.html" class="text-inherit">JavaScript: modern javaScript from the beginning</a></h4>
                                                    <!-- List inline -->
                                                    <ul class="mb-3 list-inline">
                                                        <li class="list-inline-item">
                                                            <span>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            ...
                                            <div class="card mb-4 card-hover">
                                                ...
                                                <!-- Card body -->
                                                <div class="card-body">
                                                    <h4 class="mb-2 text-truncate-line-2"><a href="course-single.html" class="text-inherit">CSS: ultimate CSS course from beginner to advanced</a></h4>
                                                    <!-- List inline -->
                                                    <ul class="mb-3 list-inline">
                                                        <li class="list-inline-item">
                                                            <span>
                                            ...
                                            <div class="card mb-4 card-hover">
                                                ...
                                                <div class="card-body">
                                                    <h4 class="mb-2 text-truncate-line-2">
                                                        <a href="course-single.html" class="text-inherit">Wordpress: complete WordPress theme &amp; plugin development</a>
                                                    </h4>
                                                    <!-- List inline -->
                                                    <ul class="mb-3 list-inline">
                                                        <li class="list-inline-item">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            <!-- Card -->
                                            <div class="card mb-4 card-hover">
                                                <a href="course-single.html"><img src="../assets/images/course/course-node.jpg" alt="" class="card-img-top"></a>
                                                <!-- Card Body -->
                                                <div class="card-body">
                                                    <h4 class="mb-2 text-truncate-line-2"><a href="course-single.html" class="text-inherit">Node.js Tutorials - For beginners and professionals</a></h4>
                                                    <!-- List inline -->
                                                    <ul class="mb-3 list-inline">
                                                        <li class="list-inline-item">
                                                            <span>
                                ...
                                <div class="tab-pane fade pb-4" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                                    ...
                                    <div class="card mb-4 card-hover">
                                        <div class="row g-0">
                                            <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded" style="background-image: url(../assets/images/course/course-vue.jpg)" href="#">
                                                <img src="../assets/images/course/course-vue.jpg" alt="..." class="img-fluid d-lg-none invisible">
                                            </a>
                                            <div class="col-lg-9 col-md-12 col-12">
                                                <!-- Card body -->
                                                <div class="card-body">
                                                    <h3 class="mb-2 text-truncate-line-2"><a href="#" class="text-inherit">Vue.js Components Fundamentals</a></h3>
                                                    <!-- List inline -->
                                    ...
                                    <div class="card mb-4 card-hover">
                                        <!-- Row -->
                                        <div class="row g-0">
                                            <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded" style="background-image: url(../assets/images/course/course-graphql.jpg)" href="#">
                                                <img src="../assets/images/course/course-graphql.jpg" alt="..." class="img-fluid d-lg-none invisible">
                                            </a>
                                            <div class="col-lg-9 col-md-12 col-12">
                                                <!-- Card body -->
                                                <div class="card-body">
                                                    <h3 class="mb-2 text-truncate-line-2"><a href="#" class="text-inherit">Getting Started WithGraphQL.js</a></h3>
                                                    <!-- List inline -->
                                                    <ul class="mb-5 list-inline">
                                                        <li class="list-inline-item">
                                                            <span>
                                    ...
                                    <div class="card mb-4 card-hover">
                                        <!-- Row -->
                                        <div class="row g-0">
                                            <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded" style="background-image: url(../assets/images/course/course-react.jpg)" href="#">
                                                <img src="../assets/images/course/course-react.jpg" alt="..." class="img-fluid d-lg-none invisible">
                                            </a>
                                            <div class="col-lg-9 col-md-12 col-12">
                                                <!-- Card body -->
                                                <div class="card-body">
                                                    <h3 class="mb-2 text-truncate-line-2"><a href="#" class="text-inherit">The Beginner's Guide to React</a></h3>
                                                    <!-- List inline -->
                                                    <ul class="mb-5 list-inline">
                                                        <li class="list-inline-item">
                                                            <span>
                                    ...
                                    <div class="card mb-4 card-hover">
                                        <div class="row g-0">
                                            ...
                                            <div class="col-lg-9 col-md-12 col-12">
                                                <!-- Card body -->
                                                <div class="card-body">
                                                    <h3 class="mb-2 text-truncate-line-2"><a href="#" class="text-inherit">Applying JavaScript and using the console.</a></h3>
                                                    <!-- List inline -->
                                                    <ul class="mb-5 list-inline">
                                                        <li class="list-inline-item">
                                                            <span>
                                    ...
                                    <div class="card mb-4 card-hover">
                                        <div class="row g-0">
                                            <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded" style="background-image: url(../assets/images/course/course-node.jpg)" href="#">
                                                <img src="../assets/images/course/course-node.jpg" alt="..." class="img-fluid d-lg-none invisible">
                                            </a>
                                            <div class="col-lg-9 col-md-12 col-12">
                                                <!-- Card body -->
                                                <div class="card-body">
                                                    <h3 class="mb-2 text-truncate-line-2"><a href="#" class="text-inherit">Node.js Tutorials - For beginners and professionals</a></h3>
                                                    <!-- list inline -->
                                                    <ul class="mb-5 list-inline">
                                                        <li class="list-inline-item">
                                                            <span>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/course-filter-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Jun 2024 14:58:40 GMT -->
</html>
