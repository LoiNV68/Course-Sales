...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/instructor-quiz-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Jun 2024 14:59:13 GMT -->
<head>
        <!-- Required meta tags -->
<meta charset="utf-8" />
                                        ...
                                        <form>
                                            ...
                                            <div>
                                                        ...
                                                        <div>
                                                            <div class="d-flex align-items-center lh-1">
                                                                ...
                                                                <div class="form-check form-switch ms-2">
                                                                    <input class="form-check-input me-0" type="checkbox" role="switch" id="flexSwitchCheckDefault" checked >
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <button type="button" class="btn btn-primary ms-2">Add Quiz</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
