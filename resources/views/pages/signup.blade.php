...
@endsection
@php
    $headerLogin = true; // or false, depending on your logic
@endphp
@section('content')
                ...
                <div class="col-lg-5 col-md-8 py-8 py-xl-0">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body p-6">
                            <div class="mb-4">
                                <a href="{{ route('home') }}"><img src="{{ asset('assets/images/brand/logo/logo-icon.svg') }}"
                            ...
                            <form class="needs-validation" action="" method="POST">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input name="term" type="checkbox" {{ old('term') ? 'checked' : '' }} class="form-check-input" id="agreeCheck" required>
                                        <label class="form-check-label" for="agreeCheck">
                                            <span>
                                                I agree to the
                                                <a href="{{ route('term-condition') }}">Terms of Service</a>
                                                and
                                                <a href="{{ route('term-condition') }}">Privacy Policy.</a>
                                            </span>
                                        </label>
                                        @error('term')
                                            <div style="color: #DB3030; font-size: 12.25px; margin-top: 4px; width: 100%;">
