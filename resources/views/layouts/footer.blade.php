            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-4">
                            <p>Geek is feature-rich components and beautifully.</p>
                            <!-- social media -->
                            <div class="fs-4 mt-4">
                                <!--Facebook-->
                                <a href="#" class=" me-2">
                ...
                <div class="col-lg-3 col-md-12">
                    ...
                    <div class="mb-4">
                        ...
                        <p>29 Hà nội</p>
                        <p class="mb-1">Email: <a href="#">ldzpro@gmail.com</a></p>
                        <p>Phone: <span class="text-dark fw-semibold">123456789</span></p>
            ...
            <div class="row align-items-center g-0 border-top py-2 mt-6">
                ...
                <div class="col-lg-4 col-md-5 col-12">
                    <span>© <span id="copyright2">
                        ...
                        </span> Course-Geeks</span>
                </div>

                <!-- Links -->
                <div class="col-12 col-md-7 col-lg-8 d-md-flex justify-content-end">
                    <nav class="nav nav-footer">
                        <a class="nav-link ps-0" href="{{route('term-condition')}}">Privacy Policy</a>

                        <a class="nav-link" href="{{route('term-condition')}}">Terms of Use</a>
                    </nav>
                </div>
            </div>
        </div>
